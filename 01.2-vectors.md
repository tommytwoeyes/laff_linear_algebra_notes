...
* the "corresponding" Greek lowercase letters are used to refer to vector components: e.g. $\vec{x}$, we use the Greek letter $\chi$ (pronounced like "kai")
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQzMzU2MTk5M119
-->